                  ...
                  <div key={game._id} className="table-row">
                      ...
                      <div className="game-title-col">
                        ...
                        <div className="status-inline">
                          ...
                          {game.visibility === 'private' && (
                            <span style={{ marginLeft: 6, fontSize: 10, fontWeight: 700, color: '#c8ff3e', background: 'rgba(200,255,62,0.1)', border: '1px solid rgba(200,255,62,0.25)', borderRadius: 20, padding: '1px 8px' }}>🔒 Private</span>
                          )}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="col col-actions">
                      <div className="action-buttons">
                        ...
                        {game.visibility === 'private' && !['completed','cancelled'].includes(game.status) && (() => {
                          ...
                          return (
                            ...
                            >
                              ...
                              {pendingCount > 0 && (
                                <span style={{ position: 'absolute', top: -5, right: -5, minWidth: 16, height: 16, borderRadius: 8, background: '#f59e0b', color: '#111', fontSize: 10, fontWeight: 800, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 4px' }}>{pendingCount}</span>
                              )}
                            </button>
                          );
                        })()}
